...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_vpe040h', 'template_50h5ii7', form.current, 'BLacF1WHTG12Vlis9')
        e.target.reset( )
    };
  return (
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+212 111 22 33 44</span>
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        <label className="contact__form-tag">Projcet</label>
